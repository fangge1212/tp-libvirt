...
def run(test, params, env):
    ...
    try:
        ...
        if transport_port:
            ...
            obj_migration.migrate_pre_setup(dest_uri, params, ports='16514')
        elif transport == 'tcp':
            obj_migration.migrate_pre_setup(dest_uri, params, ports='16509')
        ...
        if transport_port:
            ...
            obj_migration.migrate_pre_setup(dest_uri, params, cleanup=True, ports='16514')
        elif transport == 'tcp':
            obj_migration.migrate_pre_setup(dest_uri, params, cleanup=True, ports='16509')
